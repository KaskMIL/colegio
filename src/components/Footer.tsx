...
const FOOTER_LINKS = [
  {
    title: 'Institucional',
    links: ['Nuestra historia', 'Misión y valores', 'Autoridades'],
  },
  {
    title: 'Niveles',
    links: ['Jardín (La Alpina Verde)', 'Primaria', 'Secundaria'],
  },
      ...
      <Container>
        <div className={classes.grid}>
          ...
          {FOOTER_LINKS.map((col) => (
            <div key={col.title}>
              ...
              <Stack gap={8}>
                {col.links.map((link) => (
                  <a key={link} href="#" className={classes.footerLink}>
                    {link}
                  </a>
                ))}
              </Stack>
        ...
        <div className={classes.bottom}>
          <Text fz="xs" c="rgba(255,255,255,0.25)">
            © {new Date().getFullYear()} Colegio San Miguel Arcángel · DIEGEP
            5303
          </Text>
          <Group gap="lg">
            {SOCIALS.map((s) => (
