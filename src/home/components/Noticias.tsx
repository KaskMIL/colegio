import { Box, Container, Group, SimpleGrid, Skeleton, Text, Title } from '@mantine/core';
...
const FALLBACK = [
  { id: '1', tag: 'evento', date: '2026-03-15', title: 'Jornada de Puertas Abiertas', excerpt: 'Vení con tu familia a recorrer el colegio y conocer a los profes. Sábado de 10 a 13 hs.', image: null },
  { id: '2', tag: 'feria', date: '2025-11-01', title: 'Feria de Ciencias Secundaria', excerpt: 'Nuestros estudiantes presentaron proyectos increíbles sobre medio ambiente y tecnología.', image: null },
  { id: '3', tag: 'acto', date: '2025-10-01', title: 'Acto del Día de la Diversidad', excerpt: 'Toda la comunidad escolar participó en una jornada de reflexión y celebración cultural.', image: null },
];
                ...
                <FadeIn key={n.id} delay={i * 0.1}>
                  <article className={classes.article}>
                    <div className={classes.imagePlaceholder}>
                      {'image' in n && n.image ? (
                        <img
                          src={mediaUrl((n.image as { url: string }).url) ?? ''}
                          alt={n.title}
