      ...
      <div className={classes.content}>
        ...
        <div className={classes.logos}>
          <div className={classes.logoWrapper}>
            <img
              src="/assets/colegio-300x300@2x.png"
        ...
        <Text c="rgba(255,255,255,0.6)"  mb="sm">
          El nuevo sitio web del Jardín La Alpina Verde y el Colegio San Miguel
          Arcángel está en camino. Muy pronto vas a poder conocer todo sobre
